package mireya.com.school.domain.chat_mine.adapter;
...
import mireya.com.school.domain.chat_mine.data.ChatMineData;

public class ChatMineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<ChatMineData> commentsDoctorList;

    private static final int VIEW_TYPE_ME = 1;
    private static final int VIEW_TYPE_OTHER = 2;

    public void add(ChatMineData messages){
        commentsDoctorList.add(messages);
        notifyItemInserted(commentsDoctorList.size() - 1);
    }

    public ChatMineAdapter(Context context, List<ChatMineData> commentsDoctorList) {
